...
export function AppSidebar({
  ...
  const [selectedPlaylistLink, setSelectedPlaylistLink] =
  ...
  const filteredResources = resources.filter((resource) => {
    const matchesSearch =
      ...
      (resource.videoTitle &&
        resource.videoTitle.toLowerCase().includes(
    ...
    const matchesWatched =
      !showWatchedOnly || watchedVideos.has(resource.id);
  ...
  return (
    ...
    >
      ...
      >
              ...
              {activeItem.title === "All Resources" &&
                (loading
                  ...
                  : filteredResources.length > 0 ? (
                    filteredResources.map((resource) => resource.id === selectedResourceId ? (
                      ...
                      >
                        <div className="flex w-full items-center gap-2 flex-wrap">
                          ...
                          <div className="flex flex-col">
                            ...
                            <Badge
                              variant="outline"
                              className="w-fit mt-1 text-foreground border-foreground/20"
                            >
        ...
        onMouseDown={startResizing} /><Dialog open={openDialog} onOpenChange={setOpenDialog}>
